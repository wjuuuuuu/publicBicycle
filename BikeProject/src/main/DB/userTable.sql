...
INSERT INTO user1 values('admin2','admin2!','','관리자','박관리','01063212777','rhkf2l@naver.com',65,'','');
...
--렌탈 정보 등록
INSERT INTO rentalInfo values(rental_seq.nextval,'회원','','','bike21','test333','홍대입구역 8번출구 앞 (신)',TO_date('2023-02-07','yyyy-mm-dd'),'홍대입구역 8번출구 앞 (신)',TO_date('2023-02-07','yyyy-mm-dd'),300,'','');
