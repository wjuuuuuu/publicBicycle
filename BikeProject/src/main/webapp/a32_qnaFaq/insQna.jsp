...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#cancelBtn").click(function(){
			location.href="${path}/a32_qnaFaq/qnaFaqMenu.jsp" // 문의/FAQ 화면으로 이동	
		});
		...
		<div class="formdiv" style="clear:both;">
			<form method="post" enctype="multipart/form-data" action="${path}/insertQna.do" class="form-horizontal" novalidate>
			  <div class="input-group">
			    ...
			    <div class="col-sm-10">
			      <input name="title" type="text" class="form-control" id="inputTitle" placeholder="제목을 입력해주세요" required>
			    </div>
			  </div>
			  <div class="input-group">
			  ...
			  <div class="input-group">
			    ...
			    <div class="col-sm-10">
			      ...
			      <textarea name="content" rows="10" class="form-control" id="inputText" placeholder="내용을 입력해주세요" required></textarea>
			    </div>
			  </div>
			  <div class="input-group">
			    <label for="inputFile" class="col-sm-2 control-label">사진 첨부</label>
			    <div class="col-sm-10 ">
			      <input type="file" name="report" class="form-control" id="inputFile">
			    </div>
			  </div>
			  <div id="button">
