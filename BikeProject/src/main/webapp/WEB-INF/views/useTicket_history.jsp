...
<div id = "btn-table">
    <div id = "btn-table1" class = "btn-show">
        <p>이용권 현황</p>
    </div>
    <div id = "btn-table2" class = "btn-show">
       <p>받은 이용권</p>
    </div>
    <div id = "btn-table3" class = "btn-show">
       <p>보낸 이용권</p>
    </div>
</div>
</div>
</div>
<div id= "col1" class = "dataContent1">
    <div class = "cont">
        <b>이용권</b>
    </div>
    <div class = "cont">
...
<div id = "col2" class = "dataContent2">
    <div class="cont">
        <p>${list.couponCode }</p>
    </div>
    <div class="cont">
        <p><fmt:formatDate value="${list.insertDate}"/></p>
    </div>
    <div class="cont">
        <p>${list.showUse }</p>
    </div>
...
<div id = "col3" class = "dataContent1">
    <div class = "cont">
        <b>이용권</b>
    </div>
    <div class = "cont">
...
<div class = "contIndex">
<c:forEach items = "${couponList}" var = "list">
<div id = "col4" class = "dataContent2">
    <div class="cont">
        <p>${list.couponCode}</p>
    </div>
    <div class="cont">
...
<div id = "col5" class = "dataContent1">
    <div class = "cont">
        <b>이용권</b>
    </div>
    <div class = "cont">
...
<div class = "contIndex">
<c:forEach items = "${couponList}" var = "list">
<div  id = "col6" class = "dataContent2">
    <div class="cont">
        <p>${list.couponCode}</p>
    </div>
    <div class="cont">
        <p><fmt:formatDate value="${list.fromDate}"/></p>
    </div>
    <div class="cont">
        <p>${list.toUser}</p>
    </div>
...
$(".btn-show").click(function(){
	$(".btn-show").css({"border-bottom":"0px solid black"});
	$(".btn-show>p").css({"color":"rgb(173, 170, 170)"});
	
	$(this).css({"border-bottom":"5px solid black"});
	$(this).find('p').css({"color":"black"});
	
	if($(this).attr("id")==="btn-table1"){
		$($("#col1,#col2,#col3,#col4,#col5,#col6")).css({"display":"none"});
		$($("#col1,#col2")).css({"display":"flex"});
		
	}
	if($(this).attr("id")==="btn-table2"){
		$($("#col1,#col2,#col3,#col4,#col5,#col6")).css({"display":"none"});
		$($("#col3,#col4")).css({"display":"flex"});
	}
	if($(this).attr("id")==="btn-table3"){
		$($("#col1,#col2,#col3,#col4,#col5,#col6")).css({"display":"none"});
		$($("#col5,#col6")).css({"display":"flex"});
	}
